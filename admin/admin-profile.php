...
if(isset($_POST['submit'])) {
    ...
    if ($fname != "" && $lname != "" && $email != "") {
        ...
        $insersql = "UPDATE admin SET image='$image',Fname='$fname',Lname='$lname',Email='$email',Password='$password' where aID=$aID";
                ...
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto">
                      <img class="rounded-circle" src="profile/<?php echo $image;?>" alt="User Avatar" width="110"> </div>
                    <h4 class="mb-0"><?php echo $Fname, $Lname; ?></h4>
                    <span class="text-muted d-block mb-2"><?php echo $position;?></span>
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form>
                              <img src="profile/<?php if(isset($image)){echo $image;} ?> " onclick="triggerClick()" alt="profile" id="profileDisplay" style="display:block;width:100px; height:100px; margin:10px auto;">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="feFirstName" value="<?php  echo $Fname; ?>"> </div>
                              <div class="form-group col-md-6">
                                <label for="feLastName">Last Name</label>
                                <input type="text" class="form-control" id="feLastName" value="<?php  echo $Lname; ?>"> </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="feEmailAddress">Email</label>
                                <input type="email" class="form-control" id="feEmailAddress" value="<?php  echo $email; ?>"> </div>
                              <div class="form-group col-md-6">
