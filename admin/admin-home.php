...
$result2 = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM `admin`");
$row2 = mysqli_fetch_array($result2);
$count = $row2['count'];
$result3 = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM `posts`");
          ...
          <form action="#" class="main-sidebar__search w-100 border-right d-sm-flex d-md-none d-lg-none">
            <div class="input-group input-group-seamless ml-3">
              <div class="input-group-prepend">
                ...
                <a class="navbar-brand w-100 mr-0" href="admin-home.php" style="line-height: 25px;">hgh</a>
            </div>
          </form>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $count2; ?></h6>
                      </div>
                    </div>
                  ...
                  <div class="card-body p-0 d-flex">
                    <div class="d-flex flex-column m-auto">
                      <div class="stats-small__data text-center">
                        ...
                        <h6 class="stats-small__value count my-3"><?php echo $count; ?></h6>
                      </div>
                    </div>
                  ...
                  <div class="col">
                      <div class="card card-small mb-4">
                          <div class="card-header border-bottom">
                              <h6 class="m-0">Active Admin</h6>
                              <a class="btn btn-sm btn-accent ml-auto float-right" href="add-admin.php" style="line-height: 25px;">Add admin </a>
                          </div>
                          <div class="card-body p-0 pb-3 text-center">
                              <table class="table mb-0">
                                  ...
                                  <tbody>
                                  <?php
                                  $posts=mysqli_query($con,"SELECT * FROM admin WHERE status=1");
                                  ...
                                  while($res=mysqli_fetch_array($posts))
                                  {
                                      ...
                                      <tr>
                                          <td><?php echo $num; ?></td>
                                          <td><img src="profile/<?php echo $res['image'];?>" width="50" height="50"></td>
